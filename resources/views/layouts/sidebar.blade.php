        ...
        <ul class="list">
            <li>
                <div class="user-info py-3">
                    <div class="image">
                        <a href="{{url('admin/users/avatar/edit')}}" title="{{ __('section-title.avatar_edit') }}">
                            <img src="{{ Auth::user()->avatar ? asset('storage/'.Auth::user()->avatar) : asset('img/avatar/default-user.jpg') }}" alt="User">
                        </a>
                    </div>
            ...
            <li class="{{ $menu == 'skills' ? 'active open' : null }}">
                <a class="menu-toggle"><i class="zmdi zmdi-assignment"></i><span>{{ __('menu-label.skills_name') }}</span></a>
                <ul class="ml-menu">
                    <li>
                        <a href="{{\LaravelLocalization::localizeURL('admin/skills')}}">{{ __('menu-label.all_data') }}</a>
                    </li>
                    <li>
                        <a href="{{\LaravelLocalization::localizeURL('admin/skills/create')}}">{{ __('label.add') }} {{ __('label.data') }}</a>
                    </li>
                </ul>
            </li>
            @endhasrole

            <!-- Menu untuk Wali Siswa -->
            @hasrole('Wali Siswa')
            <li>
            ...
            <li class="{{ $menu == 'topics' ? 'active open' : null }}">
                <a href="{{\LaravelLocalization::localizeURL('student/topics/my-topics')}}"><i class="zmdi zmdi-file-text"></i><span>{{ __('label.material') }}</span></a>
            </li>
            <li class="{{ $menu == 'tasks' ? 'active open' : null }}">
            ...
            <li class="{{ $menu == 'report' ? 'active open' : null }}">
                <a href="{{ route('student.reports') }}"><i class="zmdi zmdi-assignment"></i><span>{{ __('menu-label.reports') }}</span></a>
            </li>
