...
<div class="row clearfix">
    <div class="col-lg-12">
        <div class="card">
            <div class="header">
                <h2><strong>{{ __('section-title.skill_add') }}</strong></h2>
            </div>
                ...
                <form method="post" action="{{route('skills.store')}}" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 form-group">
                            <button type="submit" class="float-right ml-3 btn btn-primary btn-raised btn-round waves-effect">{{ __('button-label.save') }}</button>
                        </div>
                    </div>
                </form>
            </div>
