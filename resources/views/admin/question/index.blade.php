                ...
                <form method="GET" action="">
                    <div class="row">
                        <div class="col-lg-6 col-12 form-group">
                            <select class="form-control show-tick" id="mapelSelectBox" name="subject_id" onchange="location = this.value;">
                                @if(isset($subject))
                                    @foreach ($subjects as $one_subject)
                                        <option value="{{ \LaravelLocalization::localizeURL('admin/questions/subjects/'.$one_subject->id) }}" 
                                            @if($one_subject->id == $subject->id) selected @endif>
                                            {{$one_subject->name}}
                                        </option>
                                    @endforeach
                                @else
