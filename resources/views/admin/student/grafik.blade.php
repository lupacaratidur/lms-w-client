...
<div class="row clearfix">
    <div class="col-lg-12">
        <div class="card">
            <div class="header">
                <h2><strong>Identitas Siswa</strong></h2>
                <ul class="header-dropdown">
                    <li>
                        <a role="button" href="{{\LaravelLocalization::localizeURL('admin/students')}}"><i class="zmdi zmdi-arrow-left"></i> {{ __('label.back')}}</a>
                    </li>
                </ul>
            </div>
            <div class="body">
                <table class="table table-borderless">
                    ...
                    <!-- Menambahkan data subjects di sini -->
                    <tr>
                        <td>{{ __('label.subject')}}</td>
                        <td>:</td>
                        <td style="width: 70%">
...
<script>
    ...
    var chart = new Chart(ctx, {
        ...
        data: {
            labels: skillName,
            datasets: [{
                label: 'Nilai Rata-Rata Keterampilan Siswa',
                data: skillScores,
                backgroundColor: 'rgba(75, 192, 192, 0.2)',
                borderColor: 'rgba(75, 192, 192, 1)',
                borderWidth: 1
