    ...
    <div class="col-lg-12">
        ...
        <div class="card">
            ...
            <div class="body">
                ...
                <!-- Logika untuk menampilkan catatan berdasarkan rata-rata nilai -->
                <p>
                    @if ($exam_result_count->averageScore >= 0 && $exam_result_count->averageScore <= 2)
                        Pembelajaran Remedial: Selenggarakan sesi remedial intensif dengan fokus pada materi dasar. Gunakan pendekatan yang lebih menyenangkan, seperti permainan edukatif atau penggunaan multimedia
                    @elseif ($exam_result_count->averageScore >= 2.1 && $exam_result_count->averageScore <= 4)
                        Pendekatan Kolaboratif: Dorong siswa untuk belajar dalam kelompok kecil. Pembelajaran kolaboratif dapat meningkatkan pemahaman mereka melalui diskusi dan saling membantu
                    @elseif ($exam_result_count->averageScore >= 4.1 && $exam_result_count->averageScore <= 6)
                        Pengulangan Materi: Lakukan pengulangan materi dengan cara yang bervariasi. Gunakan teknik pengajaran yang berbeda, seperti pembelajaran visual, audio, dan kinestetik
                    @elseif ($exam_result_count->averageScore >= 6.1 && $exam_result_count->averageScore <= 8)
                        Pengayaan Materi: Berikan materi pengayaan untuk siswa yang menunjukkan pemahaman yang baik, seperti proyek atau tugas tambahan yang lebih menantang
                    @elseif ($exam_result_count->averageScore >= 8.1 && $exam_result_count->averageScore <= 10)
                        Tantangan dan Kompetisi: Berikan tantangan dan kompetisi yang menstimulasi pemikiran kritis dan analitis, seperti lomba sains, debat, atau proyek penelitian
                    @endif
                </p>
</div>
