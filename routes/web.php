...
Route::group([
    ...
    });  // Middleware 'guest' akan memastikan bahwa pengguna yang belum login diarahkan ke login.
    ...
    Route::middleware(['auth'])->group(function(){
        ...
        Route::middleware(['role:Siswa'])->group(function(){
            ...
            Route::get('student/exams/results/{exam_result}', 'Exam\StudentExamResultController@show')->name('student.exams.results.show');
            ...
            Route::get('/task-submissions', 'Task\StudentTaskSubmissionController@index')->name('student.task-submission.index');
            ...
            Route::get('student/exam-results', 'Exam\StudentExamResultController@index')->name('student.exam-result.index');
            Route::get('student/reports', 'Student\StudentController@grafikSiswa')->name('student.reports');

            Route::get('exams/results/{exam_result}/responses', 'Exam\StudentExamResultController@show')
            ->name('student.exams.results.show');
        });
...
//WALI SISWA
        ...
        Route::prefix('admin')->group(function(){
            ...
            Route::middleware(['role:Pengajar'])->group(function(){
                ...
                Route::get('admin/topics', 'Learning\LearningTopicController@index')->name('admin.learning-topic.index');
                ...
                // Skill
                Route::get('skills', 'skill\skillController@index')->name('skills.index');
                Route::get('skills/{skill}/edit', 'skill\skillController@edit');
                Route::get('skills/create', 'skill\SkillController@create');
                Route::post('skills', 'Skill\SkillController@store')->name('skills.store');
                Route::patch('skills/{skill}','Skill\SkillController@update')->name('skills.update');
                Route::delete('skills', 'Skill\SkillController@destroy')->name('skills.batch.delete');

                //Skill Submission
               // Route::get('skills/{submission}/submissions', 'Skill\SkillSubmissionController@show');
                Route::get('skills/{skill}/submissions/{grade_id?}', 'Skill\SkillSubmissionController@index');
                Route::post('skills/submissions', 'Skill\SkillSubmissionController@store');
                //Route::patch('skills/submissions/{submission}', 'Skill\SkillSubmissionController@update');
                Route::delete('skills/submissions', 'Skill\SkillSubmissionController@destroy');
                Route::get('skills/submissions/{submission}/{submission2}', 'Skill\SkillSubmissionController@show');
                Route::patch('skills/submissions/{submission}', 'Skill\SkillSubmissionController@update');
                Route::delete('skills/submissions', 'Skill\skillSubmissionController@destroy');
                // Question

                // Route::patch('skills/{skill}/publish/change', 'Skill\SkillTogglePublishStatusController');
                // Route::patch('skills/{skill}/status/change', 'Skill\SkillToggleStatusController');
                // Route::get('skills/{skill}/questions/create', 'Skill\SkillQuestionController@create');
                // Route::post('skills/{skill}/questions', 'Skill\SkillQuestionController@store');
                // Route::delete('skills/{skill}/questions', 'Skill\SkillQuestionController@destroy')->name('skill-questions.batch.delete');
                // Route::post('skills/{skill}/questions/add', 'Skill\SkillQuestionController@addToSkill')->name('skills.questions.add');
                ...
                Route::get('students', 'Student\StudentController@index')->name('admin.student.index'); // Tambahkan nama route
                Route::get('students/{student}', 'Student\StudentController@grafik')->name('admin.student.grafik'); // Tambahkan nama route
            });
